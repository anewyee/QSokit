...
public:
    ...
    static QString bin2hex(const char* buf, uint len);//like : [31 32 33 77 65 71 77 65 71 77 ]
    static QString bin2hexOnly(const char* buf, uint len = 0);//like : 31 32 33 77 65 71 77 65 71 77
